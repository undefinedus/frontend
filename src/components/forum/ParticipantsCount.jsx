...
// 토론 카드형 목록
const ParticipantsCount = ({ forum, onClick, forumGuide = true }) => {
  return (
    <div className="flex flex-col gap-2 pt-4">
      <div className="flex text-undtextgray font-bold text-und14 w-full h-12 text-center justify-between px-6 gap-4">
        <div className="flex gap-2 justify-center items-center w-full bg-white border border-unddisabled rounded-md">
